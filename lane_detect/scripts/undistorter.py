...
class Undistorter:
    def __init__(self):
        try:
            self.objpoints = np.load('lane_detect/data/objpoints.npy')
            self.imgpoints = np.load('lane_detect/data/imgpoints.npy')
            self.shape = tuple(np.load('lane_detect//data/shape.npy'))
        except:
            self.objpoints = None
            self.imgpoints = None
            self.shape = None
